...
if [ $# != 5 ]; then
  ...
  echo "Specify a full path for each file or directory"
  echo "[fastq_list] should be as follows:"
  echo "<isolate_1><tab><isolate_1.R1.fq><tab><isolate_1.R2.fq>"
  echo "<isolate_2><tab><isolate_2.R1.fq><tab><isolate_2.R2.fq>"
  echo "."
  echo "."
  echo "."
  echo "<isolate_n><tab><isolate_n.R1.fq><tab><isolate_n.R2.fq>"
  exit 1
fi
